...
`,At={width:"48px",height:"48px"},Nt={color:"#161616",font:"4rem"},zt={bgColor:"#161616",iconColor:"#fff"};function Lt(){return O.jsx(Ot,{children:O.jsxs(Tt,{children:[O.jsx("img",{src:"images/welcome.png",alt:"boy with laptop"}),O.jsx(Ne,{size:At,text:Nt,icon:zt}),O.jsx(St,{children:"Supercharge your productivity and take control of your tasks with Task Pro - Don't wait, start achieving your goals now!"}),O.jsxs(Ct,{children:[O.jsx(Dt,{to:"auth/signup",children:"Registration"}),O.jsx(jt,{to:"auth/signin",children:"Log In"})]})]})})}export{Lt as default};
