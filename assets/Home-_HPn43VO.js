import{u as t,p as c,a as C,j as o,g as $,r as l}from"./index-aMtTljmD.js";import{L as k}from"./Logo-K1W_-EHM.js";import{G as h,s as z,a as M}from"./iconBase--g5ERTd-.js";import{C as H,M as S}from"./Layout--VdDjlig.js";function B(e){return h({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const O=t(B)`
  font-size: 3.2rem;
...
`,A=t.p`
  ...
  font-weight: 500;
  line-height: normal;
`;function L(){const e=C();function r(){z(M).then(()=>{e("/")}).catch(n=>{console.error("Error signing out: ",n.message)})}return o.jsxs(W,{onClick:r,children:[o.jsx(O,{}),o.jsx(A,{children:"Log out"})]})}const I=t.div`
  width: 100%;
  max-width: 212px;
  margin: 0 auto;
  padding: 14px;
...
`,y=({openHelpModal:e})=>{l.useEffect(()=>{const n=i=>{i.code==="Escape"&&e()};return window.addEventListener("keydown",n),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",n),document.body.style.overflow="auto"}},[e]);const r=n=>{n.target===n.currentTarget&&e()};return o.jsx(q,{onClick:r,children:o.jsxs(K,{className:"modal",children:[o.jsx(G,{onClick:e,type:"button",children:o.jsx(ee,{})}),o.jsxs("div",{children:[o.jsx(X,{children:"Need help"}),o.jsxs(J,{children:[o.jsx(Y,{type:"text",placeholder:"Email address"}),o.jsx(Q,{cols:"30",rows:"10",placeholder:"Comment"}),o.jsx(Z,{type:"submit",children:"Send"})]})]})]})})};y.propTypes={openHelpModal:d.func};const oe=()=>{const[e,r]=l.useState(!1),n=()=>{r(i=>!i)};return o.jsxs(o.Fragment,{children:[o.jsxs(I,{children:[o.jsx(N,{children:o.jsx("img",{src:"images/flower.png",alt:"flower"})}),o.jsxs(E,{children:["If you need help with ",o.jsx(R,{children:"TaskPro"}),", check out our support resources or reach out to our customer support team."]}),o.jsx(P,{onClick:()=>n(),children:"Need help?"})]}),e&&o.jsx(y,{openHelpModal:n})]})},te=oe,re=t.div`
  display: flex;
  flex-direction: column;
  gap: 0.8rem;
`,ne=t.p`
...
`;function pe({aside:e,handleAsideHide:r}){function n(i){i.target.localName==="aside"&&r()}return o.jsx(le,{$aside:e,onClick:i=>n(i),children:o.jsxs(ce,{$aside:e,children:[o.jsx(he,{onClick:r}),o.jsx(k,{}),o.jsx(ae,{}),o.jsxs(de,{children:[o.jsx(te,{}),o.jsx(L,{})]})]})})}function me(e){return h({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M19 17h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2z"},child:[]}]})(e)}const xe=t.div`
  display: block;
  cursor: pointer;
...
`;function v({toggleTheme:e}){const[r,n]=l.useState(!1),[i,a]=l.useState(!1);function m(){n(s=>!s),a(s=>!s)}return o.jsxs(we,{onClick:m,children:[o.jsxs(ve,{children:[o.jsx(ye,{children:"Theme"}),o.jsx(be,{children:i?o.jsx(fe,{}):o.jsx(ge,{})})]}),r&&o.jsxs(je,{children:[o.jsx(p,{onClick:s=>e(s),children:"light"},"light"),o.jsx(p,{onClick:s=>e(s),children:"dark"},"dark"),o.jsx(p,{onClick:s=>e(s),children:"violet"},"violet")]})]})}v.propTypes={toggleTheme:d.func.isRequired};const Te=t.div`
  display: flex;
  align-items: center;
  gap: 0.8rem;
`,Ce=t.p`
...
`,Me=t.div`
  ...
  /* width: 100vw; //розтягуємо модалку на ширину та висоту екрана
    height: 100vh; */
`;function He(){const[e,r]=l.useState(!1);function n(){r(a=>!a)}const i=a=>{a.currentTarget===a.target&&n()};return o.jsxs(o.Fragment,{children:[o.jsxs(Te,{onClick:i,children:[o.jsx(Ce,{children:"John"}),o.jsx(ke,{onClick:()=>n(),children:o.jsx($e,{children:o.jsx("use",{href:"images/icons.svg#icon-userAvatarDefault"})})})]}),e&&o.jsx(Me,{onClick:i,children:o.jsxs(ze,{children:[o.jsx("button",{onClick:n,className:"btnClose",children:"×"}),o.jsx("h1",{children:"333333"}),o.jsx("p",{children:"Hello"})]})})]})}const Se=t.div`
    display: flex;
    justify-content: space-between;
    align-items: center;
...
`,Be=t.div`
    ...
    align-items: center;
    gap: 1.4rem;
`;function j({toggleTheme:e,handleAsideHide:r}){return o.jsxs(Se,{children:[o.jsx(b,{handleAsideHide:r}),o.jsxs(Be,{children:[o.jsx(v,{toggleTheme:e}),o.jsx(He,{})]})]})}j.propTypes={toggleTheme:d.func,handleAsideHide:d.func};const Oe=t.div`
  width: 100%;
  height: 100%;
...
`,Ae=t.span`
  color: ${e=>e.theme.colors.themeTextHoverColor};
`;function Le(){return o.jsx(Oe,{children:o.jsxs(We,{children:["Before starting your project, it is essential",o.jsx(Ae,{children:" to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})})}function Ie({toggleTheme:e}){const[r,n]=l.useState(!1);function i(){n(a=>!a)}return o.jsxs(H,{children:[o.jsx(pe,{aside:r,handleAsideHide:i}),o.jsxs(S,{children:[o.jsx(j,{toggleTheme:e,handleAsideHide:i}),o.jsx("main",{children:o.jsx(Le,{})})]})]})}Ie.propTypes={toggleTheme:d.func.isRequired};export{Ie as default};
