import{u as o,p as s,a as w,j as t,r as c,g as v}from"./index-MDqUwzZK.js";import{L as b}from"./Logo-nWltK6ng.js";import{G as a,s as C,a as M}from"./iconBase-q_YVMxHq.js";import{C as k,M as $}from"./Layout-thJC1eA5.js";function S(e){return a({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const z=o(S)`
  font-size: 3.2rem;
...
`,W=o.p`
  ...
  font-weight: 500;
  line-height: normal;
`;function O(){const e=w(),r=()=>{C(M).then(()=>{e("/")}).catch(i=>{console.error("Error signing out: ",i.message)})};return t.jsxs(B,{onClick:r,children:[t.jsx(z,{}),t.jsx(W,{children:"Log out"})]})}const L=o.div`
  display: flex;
