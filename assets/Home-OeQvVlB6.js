import{u as h,p as z,a as Gn,j as u,g as $t,r as p,b as Xn,c as Kn}from"./index-tBQRuE3B.js";import{L as Jn}from"./Logo-xE0N0Gt1.js";import{G as fe,h as Yn,e as ei}from"./emailRegex-nXuB65_f.js";import{C as ti,M as ri}from"./Layout-3moeF8bZ.js";function ni(e){return fe({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const ii=h(ni)`
  font-size: 3.2rem;
...
`,pi=h(li)`
  ...
  color: ${e=>e.theme.colors.mainTextColor};
  margin-right: 8px;
`;var zr={exports:{}},mi="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",gi=mi,yi=gi;function Vr(){}function Ur(){}Ur.resetWarningCache=Vr;var bi=function(){function e(n,i,o,a,s,c){if(c!==yi){var d=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw d.name="Invariant Violation",d}}e.isRequired=e;function t(){return e}var r={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:Ur,resetWarningCache:Vr};return r.PropTypes=r,r};zr.exports=bi();var vi=zr.exports;const ue=$t(vi);function Qe(e){return fe({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"m289.94 256 95-95A24 24 0 0 0 351 127l-95 95-95-95a24 24 0 0 0-34 34l95 95-95 95a24 24 0 1 0 34 34l95-95 95 95a24 24 0 0 0 34-34z"},child:[]}]})(e)}const xi=h.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
...
`,Sc=()=>{const[e,t]=p.useState(!1),r=()=>{t(n=>!n)};return u.jsxs(vc,{children:[u.jsx(xc,{children:"My boards"}),u.jsxs(Tc,{children:[u.jsx(wc,{children:"Create a new board"}),u.jsx(Ec,{onClick:()=>r(),children:u.jsx(Ac,{})})]}),e&&u.jsx(bc,{openNewBoardModal:r})]})},jc=Sc,$c=h.aside`
...
`;function Oc({aside:e,handleAsideHide:t}){const[r,n]=p.useState(!1),i=p.useRef();p.useEffect(()=>{const a=i.current,s=()=>{n(a.scrollTop>0)};return a.addEventListener("scroll",s),()=>{a.removeEventListener("scroll",s)}},[]);function o(a){a.target.localName==="aside"&&t()}return u.jsx($c,{$aside:e,onClick:a=>o(a),children:u.jsxs(Cc,{ref:i,$aside:e,$scrollable:r,children:[u.jsx(Fc,{onClick:t}),u.jsx(Jn,{}),u.jsx(jc,{}),u.jsxs(_c,{children:[u.jsx(Fi,{}),u.jsx(si,{})]})]})})}function kc(e){return fe({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M19 17h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2z"},child:[]}]})(e)}const Ic=h.div`
  display: block;
  cursor: pointer;
...
`,gt=h.span`
  ...
  top: -1.5rem;
  bottom: 0;
`,id=Ht().shape({avatar:Ae(),name:Ae().min(3,"Too Short!").max(50,"Too Long!"),email:Ae().matches(ei,"Invalid email address"),password:Ae().min(8,"Must Contain 8 Characters").matches(/^(?=.*[a-z])/," Must Contain One Lowercase Character").matches(/^(?=.*[A-Z])/,"  Must Contain One Uppercase Character").matches(/^(?=.*[0-9])/,"  Must Contain One Number Character").matches(/^(?=.*[!@#\$%\^&\*])/,"Must Contain One Special Case Character")});function od(){const[e,t]=p.useState("images/VectorExample.png"),r=En({initialValues:{avatar:"images/VectorExample.png",name:"",email:"",password:""},validationSchema:id,onSubmit:i=>{console.log(i)}}),n=i=>{const{name:o,type:a,files:s}=i.target,c=a==="file"?s[0]:i.target.value;if(r.handleChange(i),r.setFieldValue(o,c),a==="file"){const d=new FileReader;d.onload=()=>{d.readyState===2&&t(d.result)},s[0]&&d.readAsDataURL(s[0])}};return u.jsxs(Xc,{onSubmit:r.handleSubmit,children:[u.jsxs(Kc,{children:[u.jsx(Jc,{src:e}),u.jsx(ed,{children:u.jsx(td,{})})]}),u.jsx("div",{children:u.jsx(Yc,{htmlFor:"button-file",children:u.jsx("input",{name:"avatar",accept:"image/*",id:"button-file",type:"file",hidden:!0,onChange:n})})}),u.jsxs(mt,{children:[r.touched.name&&r.errors.name&&u.jsx(gt,{className:"error-message",children:r.errors.name}),u.jsx(Lr,{type:"text",name:"name",value:r.values.name,onChange:n})]}),u.jsxs(mt,{children:[r.touched.email&&r.errors.email&&u.jsx(gt,{className:"error-message",children:r.errors.email}),u.jsx(Lr,{type:"text",name:"email",value:r.values.email,onChange:n})]}),u.jsxs(mt,{children:[r.touched.password&&r.errors.password&&u.jsx(gt,{className:"error-message",children:r.errors.password}),u.jsx(rd,{type:"password",name:"password",className:"nth-child",value:r.values.password,onChange:n})]}),u.jsx(nd,{type:"submit",children:"Send"})]})}function ad({toggleModal:e}){p.useEffect(()=>{const r=n=>{n.code==="Escape"&&e()};return window.addEventListener("keydown",r),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",r),document.body.style.overflow="auto"}},[e]);const t=r=>{r.currentTarget===r.target&&e()};return u.jsx(u.Fragment,{children:u.jsx(Qc,{onClick:t,children:u.jsxs(Zc,{children:[u.jsx(qc,{onClick:e,className:"btnClose"}),u.jsx(Gc,{children:"Edit Profile"}),u.jsx(od,{})]})})})}function sd(){const[e,t]=p.useState(!1),{user:r}=Kn();function n(){t(i=>!i)}return u.jsxs(u.Fragment,{children:[u.jsxs(Vc,{children:[u.jsx(Uc,{children:r.name}),u.jsx(Wc,{onClick:()=>n(),children:u.jsx(Hc,{children:u.jsx("use",{href:"images/icons.svg#icon-userAvatarDefault"})})})]}),e&&u.jsx(ad,{toggleModal:n})]})}const ld=h.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
