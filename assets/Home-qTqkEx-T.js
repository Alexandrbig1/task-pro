import{u as t,p as s,a as T,j as o,r as a,g as v}from"./index-cOFB3JLK.js";import{L as b}from"./Logo-_eZDeXv5.js";import{G as l,s as C,a as k}from"./iconBase-h7g8Xldp.js";import{C as M,M as $}from"./Layout-w-Blucrz.js";function S(e){return l({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const z=t(S)`
  font-size: 3.2rem;
...
`,W=t.p`
  ...
  font-weight: 500;
  line-height: normal;
`;function H(){const e=T();function r(){C(k).then(()=>{e("/")}).catch(n=>{console.error("Error signing out: ",n.message)})}return o.jsxs(B,{onClick:r,children:[o.jsx(z,{}),o.jsx(W,{children:"Log out"})]})}const O=t.div`
  width: 100%;
  max-width: 212px;
  height: 272px;
  margin: 0 auto;
...
`,N=t.button`
  ...
  border: none;
  outline: none;
`,R=()=>{const[e,r]=a.useState(!1),n=()=>{r(!0)};return o.jsxs(o.Fragment,{children:[o.jsxs(O,{children:[o.jsx(L,{children:o.jsx("img",{src:"images/flower.png",alt:"flower"})}),o.jsx(P,{children:"If you need help with TaskPro, check out our support resources or reach out to our customer support team."}),o.jsx(N,{onClick:()=>n(),children:"Need help?"})]}),e&&o.jsx("div",{className:"modal"})]})},I=R,E=t.div`
  display: flex;
...
`,U=t.div`
  ...
  flex-direction: column;
  gap: 2.4rem;
`;function V(){return o.jsxs(q,{children:[o.jsx(b,{}),o.jsx(D,{}),o.jsxs(U,{children:[o.jsx(I,{}),o.jsx(H,{})]})]})}function G(e){return l({tag:"svg",attr:{version:"1.2",baseProfile:"tiny",viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M19 17h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 10h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2zM19 3h-14c-1.103 0-2 .897-2 2s.897 2 2 2h14c1.103 0 2-.897 2-2s-.897-2-2-2z"},child:[]}]})(e)}const K=t.div`
  display: block;
  cursor: pointer;
...
`,he=t.div`
  display: flex;
  gap: 0.8rem;
`;function j({toggleTheme:e}){return o.jsxs(ce,{children:[o.jsx(Y,{}),o.jsxs(pe,{children:[o.jsx(y,{toggleTheme:e}),o.jsxs(he,{children:[o.jsx("p",{children:"John"}),o.jsx("span",{children:"img"})]})]})]})}j.propTypes={toggleTheme:p.func.isRequired};const de=t.div`
  width: 100%;
...
`,xe=t.span`
  color: ${e=>e.theme.colors.themeTextHoverColor};
`;function ue(){return o.jsx(de,{children:o.jsxs(me,{children:["Before starting your project, it is essential",o.jsx(xe,{children:" to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})})}function ge({toggleTheme:e}){return o.jsxs(M,{children:[o.jsx(V,{}),o.jsxs($,{children:[o.jsx(j,{toggleTheme:e}),o.jsx("main",{children:o.jsx(ue,{})})]})]})}ge.propTypes={toggleTheme:p.func.isRequired};export{ge as default};
