...
`,xt=f.span`
  ...
  top: -1.5rem;
  bottom: 0;
`,ad=Zt().shape({avatar:Ae(),name:Ae().min(3,"Too Short!").max(50,"Too Long!"),email:Ae().matches(no,"Invalid email address"),password:Ae().min(8,"Must Contain 8 Characters").matches(/^(?=.*[a-z])/," Must Contain One Lowercase Character").matches(/^(?=.*[A-Z])/,"  Must Contain One Uppercase Character").matches(/^(?=.*[0-9])/,"  Must Contain One Number Character").matches(/^(?=.*[!@#\$%\^&\*])/,"Must Contain One Special Case Character")});function sd(){const[e,t]=p.useState("images/VectorExample.png"),r=jn({initialValues:{avatar:"images/VectorExample.png",name:"",email:"",password:""},validationSchema:ad,onSubmit:o=>{console.log(o)}}),n=o=>{const{name:i,type:a,files:s}=o.target,u=a==="file"?s[0]:o.target.value;if(r.handleChange(o),r.setFieldValue(i,u),a==="file"){const d=new FileReader;d.onload=()=>{d.readyState===2&&t(d.result)},s[0]&&d.readAsDataURL(s[0])}};return l.jsxs(Yu,{onSubmit:r.handleSubmit,children:[l.jsxs(ed,{children:[l.jsx(td,{src:e}),l.jsxs(rd,{htmlFor:"button-file",children:[l.jsx("input",{name:"avatar",accept:"image/*",id:"button-file",type:"file",hidden:!0,onChange:n}),l.jsx(nd,{})]})]}),l.jsx("div",{}),l.jsxs(bt,{children:[r.touched.name&&r.errors.name&&l.jsx(xt,{className:"error-message",children:r.errors.name}),l.jsx(Ur,{type:"text",name:"name",value:r.values.name,onChange:n})]}),l.jsxs(bt,{children:[r.touched.email&&r.errors.email&&l.jsx(xt,{className:"error-message",children:r.errors.email}),l.jsx(Ur,{type:"text",name:"email",value:r.values.email,onChange:n})]}),l.jsxs(bt,{children:[r.touched.password&&r.errors.password&&l.jsx(xt,{className:"error-message",children:r.errors.password}),l.jsx(od,{type:"password",name:"password",className:"nth-child",value:r.values.password,onChange:n})]}),l.jsx(id,{type:"submit",children:"Send"})]})}function ld({toggleModal:e}){p.useEffect(()=>{const r=n=>{n.code==="Escape"&&e()};return window.addEventListener("keydown",r),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",r),document.body.style.overflow="auto"}},[e]);const t=r=>{r.currentTarget===r.target&&e()};return l.jsx(l.Fragment,{children:l.jsx(Gu,{onClick:t,children:l.jsxs(Xu,{children:[l.jsx(Ku,{onClick:e,className:"btnClose"}),l.jsx(Ju,{children:"Edit Profile"}),l.jsx(sd,{})]})})})}function cd(){const[e,t]=p.useState(!1),{user:r}=eo();function n(){t(o=>!o)}return l.jsxs(l.Fragment,{children:[l.jsxs(Wu,{children:[l.jsx(Qu,{children:r.name}),l.jsx(qu,{onClick:()=>n(),children:l.jsx(Zu,{children:l.jsx("use",{href:"images/icons.svg#icon-userAvatarDefault"})})})]}),e&&l.jsx(ld,{toggleModal:n})]})}const ud=f.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
...
`,We=f.label`
  ...
  letter-spacing: -0.02em;
  color: rgba(255, 255, 255, 0.5);
`;function Sd({closeModal:e}){return p.useEffect(()=>{const t=r=>{r.code==="Escape"&&e()};return window.addEventListener("keydown",t),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",t),document.body.style.overflow="auto"}},[e]),l.jsx(md,{children:l.jsxs(gd,{children:[l.jsx(bd,{onClick:()=>e(),children:l.jsx(xd,{})}),l.jsx(yd,{children:"Filters"}),l.jsxs(vd,{children:[l.jsxs(wd,{children:[l.jsx(Td,{children:"Label color"}),l.jsx(Ed,{children:"Show all"})]}),l.jsxs(Ad,{children:[l.jsx(Ue,{children:l.jsxs(We,{children:[l.jsx(He,{type:"radio",name:"priority",value:"without"}),"Without priority"]})}),l.jsx(Ue,{children:l.jsxs(We,{children:[l.jsx(He,{type:"radio",name:"priority",value:"Low"}),"Low"]})}),l.jsx(Ue,{children:l.jsxs(We,{children:[l.jsx(He,{type:"radio",name:"priority",value:"Medium"}),"Medium"]})}),l.jsx(Ue,{children:l.jsxs(We,{children:[l.jsx(He,{type:"radio",name:"priority",value:"High"}),"High"]})})]})]})]})})}function jd(){const[e,t]=p.useState(!1),r=()=>{t(!e)};return l.jsxs(l.Fragment,{children:[e&&l.jsx(Sd,{closeModal:r}),l.jsxs(hd,{onClick:r,children:[l.jsx(pd,{}),"Filters"]})]})}const $d=f.div`
  width: 100%;
  height: 100%;
  position: relative;
...
`,_d=f.span`
  color: ${e=>e.theme.colors.themeTextHoverColor};
`;function Fd(){return l.jsxs($d,{children:[l.jsx(jd,{}),l.jsxs(Cd,{children:["Before starting your project, it is essential",l.jsx(_d,{children:" to create a board"})," to visualize and track all the necessary tasks and milestones. This board serves as a powerful tool to organize the workflow and ensure effective collaboration among team members."]})]})}function kd({toggleTheme:e}){const[t,r]=p.useState(!1);function n(){r(o=>!o)}return l.jsxs(oo,{children:[l.jsx(Mu,{aside:t,handleAsideHide:n}),l.jsxs(io,{children:[l.jsx(Dn,{toggleTheme:e,handleAsideHide:n}),l.jsx("main",{children:l.jsx(Fd,{})})]})]})}kd.propTypes={toggleTheme:ue.func.isRequired};export{kd as default};
