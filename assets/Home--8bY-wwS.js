import{u as t,p as v,c as $,j as o,l as ne,r as h,d as ae,B as O,e as ie,f as R,g as T,h as se,i as U,N as le,b as ce,k as V,m as F,n as A,s as _,o as de,q as he,t as me,H as pe,a as ue,O as xe}from"./index-8xMv0Qb6.js";import{L as ge}from"./Logo-ZSBFzo_i.js";import{G as k}from"./iconBase-xNWISYd1.js";import{P as b}from"./hoist-non-react-statics.cjs-5nzVeZx_.js";import{e as q,B as fe,a as ye}from"./index-POTJotTR.js";import{I as B,F as K,a as C,c as H,b as j,d as Z,E as X,C as G,s as Q,e as Y,u as ve,f as we}from"./selectors-DcuQRNut.js";function be(e){return k({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"},child:[]}]})(e)}const ke=t(be)`
  font-size: 3.2rem;
...
`,Re=t(Fe)`
  ...
  color: ${e=>e.theme.colors.mainTextColor};
  margin-right: 8px;
`,Ue=()=>{const[e,r]=h.useState(!1),n=()=>{r(s=>!s)};return o.jsxs(o.Fragment,{children:[o.jsxs(Ae,{children:[o.jsx(Pe,{children:o.jsx("img",{src:"images/flower.png",alt:"flower"})}),o.jsxs(We,{children:["If you need help with ",o.jsx(De,{children:"TaskPro"}),", check out our support resources or reach out to our customer support team."]}),o.jsxs(Ne,{onClick:()=>n(),children:[o.jsx(Re,{}),"Need help?"]})]}),e&&o.jsx(J,{openHelpModal:n})]})},Ve=Ue,E="/task-pro/assets/icons-EKrRu2KP.svg",_e=t(K)`
  margin: 0;
  position: relative;
`,P=t.p`
  color: ${e=>e.theme.colors.secondaryTextColor};
...
`;function po({openNewBoardModal:e}){h.useEffect(()=>{const s=d=>{d.code==="Escape"&&e()};return window.addEventListener("keydown",s),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",s),document.body.style.overflow="auto"}},[e]);const r=s=>{s.target===s.currentTarget&&e()},n=()=>{e()};return R.createPortal(o.jsx(so,{onClick:r,children:o.jsxs(lo,{children:[o.jsx(ho,{onClick:e,children:o.jsx(mo,{})}),o.jsx(co,{children:"New board"}),o.jsx(ee,{closeModal:n})]})}),document.getElementById("modal-root"))}const W="/task-pro/assets/icons-150_NXcY.svg",uo=t(K)`
  margin: 0;
  position: relative;
`,N=t.p`
  color: ${e=>e.theme.colors.secondaryTextColor};
...
`,Jo=()=>{const[e,r]=h.useState(!1),[n,s]=h.useState(!1),[d,c]=h.useState(""),l=ce(),x=$(),a=V(),u=T(Q),y=g=>{x(U(g))},i=()=>{r(g=>!g)},m=g=>{c(g),s(p=>!p)};h.useEffect(()=>{x(F())},[x]);const f=g=>{x(A(g)).then(p=>{p.type===A.fulfilled.type?(x(F()),l("/home")):console.log("Виникла помилка під час завантаження даних:")})};return o.jsxs(No,{children:[o.jsxs(Do,{children:[o.jsx(Ro,{children:"My boards"}),o.jsxs(Uo,{children:[o.jsx(Vo,{children:"Create a new board"}),o.jsx(_o,{onClick:()=>i(),children:o.jsx(qo,{})})]}),e&&o.jsx(po,{openNewBoardModal:i})]}),o.jsx(Ko,{children:u.map(({_id:g,icon:p,titleBoard:w})=>o.jsx("li",{onClick:()=>y(g),children:o.jsxs(Zo,{to:`/home/${w}`,state:{from:a},children:[o.jsxs(Go,{children:[o.jsx(I,{children:o.jsx("svg",{width:"18",height:"18",children:o.jsx("use",{href:`${E}#${p}-dark`})})}),o.jsx(M,{children:w})]}),o.jsxs(Xo,{children:[o.jsx(Qo,{onClick:()=>m(g)}),o.jsx(Yo,{onClick:()=>f(g)})]})]})},g))}),n&&o.jsx(Ao,{openEditBoardModal:m,boardId:d})]})},et=Jo,ot=t.aside`
