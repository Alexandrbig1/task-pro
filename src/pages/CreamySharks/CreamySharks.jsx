      ...
      <SharksTextContainer>
        ...
        <SharksTeamContainer>
          <SharksTextWrapper>
            ...
            <SharksText>
              ...
              the world of full-stack development at{" "}
              <a
              ...
              present our final project that showcases the skills and knowledge
              acquired during this intensive program.
            </SharksText>
          </SharksTextWrapper>
          <SharksTeamWrapper>
        ...
        <ImgCardsContainer>
          <ImgCardsMenu>
            ...
            <ImgCardsItems>
              <Images src="./images/team/olena.jpg" alt="Olena Nechyporenko" />
              <ImgCardItemsWrapper>
                <ImgWrapper>
                  <div>
            ...
            <ImgCardsItems>
              <Images src="./images/team/vlad-p.jpg" alt="Vlad Parkhomovych" />
              <ImgCardItemsWrapper>
                <ImgWrapper>
                  <div>
